  ...
  data.forEach((d, i) => {
    if (d.text !== '') {
      svg
        ...
        .attr(
          'transform',
          `translate(${xScale(i * rectWidth) + rectWidth / 3} ${
            height - margin.bottom - secondaryTextPadding
          }) rotate(90)`
        )
    ...
    if (d.t !== '') {
      svg
        ...
        .attr(
          'transform',
          `translate(${xScale(i * rectWidth) + rectWidth / 3} ${margin.top + secondaryTextPadding}) rotate(90)`
        )
        .style('font-weight', 'normal')
        .style('font-size', rectWidth / 2 + 'px')
        .style('fill', 'black')
